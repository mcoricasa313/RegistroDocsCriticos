...
{
    public $expedientes,$numero_expediente,
        $asunto,$numero_documento,$folios,$remitente,$prioridad
        ,$uo_destino,$estado,$observacion,$fefefefe;
    ...
    public function render()
    {
        ...
        return view('livewire.expediente');
    }
